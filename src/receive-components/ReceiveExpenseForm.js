...
export default class ReceiveExpenceForm extends React.Component {
  constructor(props) {
    super(props);

    this.state = {
      rentName: props.receiveExpence ? props.receiveExpence.rentName : '',  
      description: props.receiveExpence ? props.receiveExpence.description : '',
      rentItem: props.receiveExpence ? (props.receiveExpence.rentItem).toString(): '',
      rentPhone: props.receiveExpence ? (props.receiveExpence.rentPhone).toString(): '',
      note: props.receiveExpence ? props.receiveExpence.note : '',
      amount: props.receiveExpence ? (props.receiveExpence.amount / 100).toString() : '',
      createdAt: props.receiveExpence ? moment(props.receiveExpence.createdAt) : moment(),
    ...
    return (
      <div>
        ...
        <input
          ...
          />
          <textarea
            placeholder="Add a note for your receiveExpence (optional)"
            value={this.state.note}
            onChange={this.onNoteChange}
          >
          </textarea>
          <button>Add Receive Expense</button>
        </form>
      </div>
    )
  }
